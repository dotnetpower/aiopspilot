...
DOCKERFILE = CORE_PROJECT / "docker" / "Dockerfile"
...
EXPECTED_RUNTIME_MODULES = {
    ...
    "bootstrap_messaging.py",
    "bootstrap_pantheon.py",
    "bootstrap_plan.py",
    "bootstrap_resources.py",
    "bootstrap_semantics.py",
    "bootstrap_shutdown.py",
    "bootstrap_task_hooks.py",
    "bootstrap_tasks.py",
    "bootstrap_topics.py",
    "case_history.py",
    "catalog_ontology.py",
    "configuration.py",
    "continuous_operating_model.py",
    "consumers.py",
    "control_loop.py",
    ...
    "operating_intent_revalidation.py",
    "operating_intent_source.py",
    "operating_model.py",
