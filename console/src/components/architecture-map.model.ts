...
const TYPE_LAYER: Readonly<Record<string, ArchitectureLayer>> = {
  ...
  "kubernetes.endpoints": "runtime",
  "kubernetes.endpoint-slice": "runtime",
  "kubernetes.ingress": "runtime",
  "kubernetes.ingress-class": "runtime",
  "kubernetes.job": "runtime",
  "kubernetes.cron-job": "runtime",
  "kubernetes.deployment": "runtime",
  "kubernetes.replica-set": "runtime",
  "kubernetes.daemon-set": "runtime",
  "kubernetes.stateful-set": "runtime",
  "kubernetes.persistent-volume-claim": "runtime",
  "kubernetes.persistent-volume": "runtime",
  "kubernetes.storage-class": "runtime",
  "kubernetes.horizontal-pod-autoscaler": "runtime",
  "kubernetes.pod-disruption-budget": "runtime",
  "kubernetes.network-policy": "runtime",
  "kubernetes.resource-quota": "runtime",
  "kubernetes.limit-range": "runtime",
  "llm-endpoint": "runtime",
  "llm-model-deployment": "runtime",
  ...
  "data-collection-endpoint": "observability",
  "alert-rule": "observability",
  "action-group": "observability",
...
const TYPE_COLOR_TOKEN: Readonly<Record<string, ArchitectureResourceColorToken>> = {
  ...
  "kubernetes.namespace": "aks",
  "kubernetes.node": "aks",
  "kubernetes.pod": "aks",
  "kubernetes.service": "aks",
  "kubernetes.endpoints": "aks",
  "kubernetes.endpoint-slice": "aks",
  "kubernetes.ingress": "aks",
  "kubernetes.ingress-class": "aks",
  "kubernetes.job": "aks",
  "kubernetes.cron-job": "aks",
  "kubernetes.deployment": "aks",
  "kubernetes.replica-set": "aks",
  "kubernetes.daemon-set": "aks",
  "kubernetes.stateful-set": "aks",
  "kubernetes.persistent-volume-claim": "aks",
  "kubernetes.persistent-volume": "aks",
  "kubernetes.storage-class": "aks",
  "kubernetes.horizontal-pod-autoscaler": "aks",
  "kubernetes.pod-disruption-budget": "aks",
  "kubernetes.network-policy": "aks",
  "kubernetes.resource-quota": "aks",
  "kubernetes.limit-range": "aks",
  "llm-endpoint": "app-service",
  "llm-model-deployment": "app-service",
  ...
  "data-collection-endpoint": "azure-monitor",
