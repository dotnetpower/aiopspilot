...
CHALLENGE_QUESTION_CONTRACTS: Mapping[str, TypedQuestionContract] = MappingProxyType(
    {
        ...
        "ontology-function-count": TypedQuestionContract(
            intent="query.manifest",
            scope_kind="active_ontology_release",
            target_cardinality="set_aggregate",
            required_authority="server_ontology_manifest",
        ...
        "ontology-interface-count": TypedQuestionContract(
            intent="query.manifest",
            scope_kind="active_ontology_release",
            target_cardinality="set_aggregate",
            required_authority="server_ontology_manifest",
        ...
        "ontology-link-count": TypedQuestionContract(
            intent="query.manifest",
            scope_kind="active_ontology_release",
            target_cardinality="set_aggregate",
            required_authority="server_ontology_manifest",
        ...
        "ontology-object-count": TypedQuestionContract(
            intent="query.manifest",
            scope_kind="active_ontology_release",
            target_cardinality="set_aggregate",
            required_authority="server_ontology_manifest",
        ...
        "ontology-resource-declaration": TypedQuestionContract(
            intent="query.ontology_declaration",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            required_capability=("query.ontology_declaration",),
            result_shape="declaration_detail",
            allowed_evidence_posture=("authoritative_current", "explicit_unknown"),
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Resource",),
        ),
        "ontology-incident-declaration": TypedQuestionContract(
            intent="query.ontology_declaration",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Incident",),
        ),
        "ontology-agent-declaration": TypedQuestionContract(
            intent="query.ontology_declaration",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Agent",),
        ),
        "ontology-business-service-declaration": TypedQuestionContract(
            intent="query.ontology_declaration",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:BusinessService",),
        ),
        "ontology-change-declaration": TypedQuestionContract(
            intent="query.ontology_declaration",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Change",),
        ),
        "ontology-finding-declaration": TypedQuestionContract(
            intent="query.ontology_declaration",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Finding",),
        ),
        "ontology-recovery-plan-declaration": TypedQuestionContract(
            intent="query.ontology_declaration",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:RecoveryPlan",),
        ),
        "ontology-workload-declaration": TypedQuestionContract(
            intent="query.ontology_declaration",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Workload",),
        ),
        "ontology-approval-declaration": TypedQuestionContract(
            intent="query.ontology_declaration",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Approval",),
        ),
        "ontology-decision-declaration": TypedQuestionContract(
            intent="query.ontology_declaration",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Decision",),
        ),
        "ontology-observation-declaration": TypedQuestionContract(
            intent="query.ontology_declaration",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Observation",),
        ),
        "ontology-rule-declaration": TypedQuestionContract(
            intent="query.ontology_declaration",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Rule",),
        ),
        "ontology-service-objective-declaration": TypedQuestionContract(
            intent="query.ontology_declaration",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:ServiceObjective",),
        ),
        "ontology-resource-relationships": TypedQuestionContract(
            intent="query.ontology_relationships",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            required_capability=("query.ontology_relationships",),
            result_shape="relationship_list",
            allowed_evidence_posture=("authoritative_current", "explicit_unknown"),
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Resource", "direction:both"),
        ),
        "ontology-agent-relationships": TypedQuestionContract(
            intent="query.ontology_relationships",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Agent", "direction:both"),
        ),
        "ontology-business-service-relationships": TypedQuestionContract(
            intent="query.ontology_relationships",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:BusinessService", "direction:both"),
        ),
        "ontology-change-relationships": TypedQuestionContract(
            intent="query.ontology_relationships",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Change", "direction:both"),
        ),
        "ontology-incident-relationships": TypedQuestionContract(
            intent="query.ontology_relationships",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Incident", "direction:both"),
        ),
        "ontology-workload-relationships": TypedQuestionContract(
            intent="query.ontology_relationships",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Workload", "direction:both"),
        ),
        "ontology-approval-relationships": TypedQuestionContract(
            intent="query.ontology_relationships",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Approval", "direction:both"),
        ),
        "ontology-decision-relationships": TypedQuestionContract(
            intent="query.ontology_relationships",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Decision", "direction:both"),
        ),
        "ontology-observation-relationships": TypedQuestionContract(
            intent="query.ontology_relationships",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Observation", "direction:both"),
        ),
        "ontology-rule-relationships": TypedQuestionContract(
            intent="query.ontology_relationships",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:Rule", "direction:both"),
        ),
        "ontology-service-objective-relationships": TypedQuestionContract(
            intent="query.ontology_relationships",
            scope_kind="active_ontology_release",
            target_cardinality="single_declaration",
            required_authority="server_ontology_manifest",
            ...
            interaction_target="server_owned_read_surface",
            time_window="current",
            required_facets=("declaration:ServiceObjective", "direction:both"),
        ),
        ...
        "resource-state": TypedQuestionContract(
            ...
            required_authority="multiple_authoritative_sources",
            required_capability=(
        ...
        "resource-health-timeline": TypedQuestionContract(
            ...
            scope_kind="configured_subscription",
            target_cardinality="collection",
            required_authority="server_resource_health",
