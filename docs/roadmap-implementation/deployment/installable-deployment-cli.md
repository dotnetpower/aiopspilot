...
| Protected artifact and identity bootstrap seams | implemented | `fdai_deployment_cli.oci_archive`, `fdai_deployment_cli.acr_publish`, `fdai_deployment_cli.entra_graph`, `fdai_deployment_cli.entra_bootstrap`, and focused tests | The library validates bounded OCI bytes before ACR credentials and reconciles tenant-bound Entra apps, service principals, groups, roles, and optional explicit-owner consent. Both seams require independent readback and expose no public command or authorization decision. |
