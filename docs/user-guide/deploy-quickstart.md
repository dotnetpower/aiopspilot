...
derives_from: [{ source: docs/roadmap/deployment/deploy-and-onboard.md, sha: 43b2d26ece4c4634d388419f4ff3ad201fc0d3f7 }]
---
...
- When you promote a reviewed blue/green candidate, set its existing VM name in
  ...
  and recovers a specialized VM's public SSH input from Azure before it verifies
