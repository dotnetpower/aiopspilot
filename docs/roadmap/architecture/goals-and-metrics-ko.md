...
translation_source_sha: b74e765f08679f074268f4ef3a05196c5f1343de
...
| 고정된 시나리오 집합 계산 | in-progress | `tests/scenarios/manifest.schema.json`; `tests/scenarios/manifests/v2026.09.json`; `test_v2026_09_frozen.py`; `test_v2026_09_replay.py` | 다섯 묶음 모두 일반 재생 커버리지를 갖추었지만 FDAI-CONST-005의 기능별 결과 근거가 생길 때까지 각각 `partial` 상태를 유지합니다. 비어 있지 않은 일반 커버리지 배열만으로는 묶음을 완료할 수 없습니다. |
