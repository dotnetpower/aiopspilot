...
| Assurance Twin posture/review activity, durable ledger, Operator API, and Console panel | Heimdall-owned bounded `agent.operational-activity` tip (`assurance-twin.posture` kind, schema `1.2.0`, no authority) for a computed `PostureAssessmentReport` or ambient `IacReview`; the durable body persists in the existing `state_kv` ledger (latest-wins per scope, idempotent per `review_key`); the Operator API renders it verbatim through `/assurance-twin/posture`, `/assurance-twin/reviews`, and `/assurance-twin/reviews/{review_id}`; the Console `assurance-twin` route renders the posture KPIs, review list, and per-review drill-down | [posture activity](../../../services/core-control-plane/src/fdai/core/assurance_twin/posture_activity.py), [delivery recorder](../../../services/core-control-plane/src/fdai/delivery/assurance_twin_posture.py), [durable ledger](../../../services/core-control-plane/src/fdai/delivery/persistence/state_store_assurance_twin_posture.py), [Operator projection](../../../services/operator-service/src/fdai_operator_service/assurance_twin_posture_projection.py), and [Console route](../../../console/src/routes/assurance-twin.tsx) | [posture activity tests](../../../services/core-control-plane/tests/assurance_twin/test_posture_activity.py), [delivery tests](../../../services/core-control-plane/tests/delivery/test_assurance_twin_posture.py), [ledger tests](../../../services/core-control-plane/tests/persistence/test_state_store_assurance_twin_posture.py), [Operator projection tests](../../../services/operator-service/tests/test_assurance_twin_posture_projection.py), and [Console tests](../../../console/src/routes/assurance-twin.test.ts) |
