...
| Assurance Twin posture/review activity, durable ledger, Operator API, and Console panel | Heimdall-owned bounded `agent.operational-activity` tip (`assurance-twin.posture` kind, schema `1.2.0`, no authority) for a computed `PostureAssessmentReport` or ambient `IacReview`, recorded by Heimdall when an ambient twin candidate arrives on its declared `object.event` subscription; the durable body persists in the existing `state_kv` ledger (latest-wins per scope, idempotent per `review_key`, explicit conflict on a mismatched redelivery) with activity, correlation, and evidence-digest provenance; the Operator API renders it verbatim through `/assurance-twin/posture`, `/assurance-twin/reviews`, and `/assurance-twin/reviews/{review_id}` and withholds stale, unavailable, unknown, malformed, or digest-mismatched rows as explicit gaps; the Console `assurance-twin` route renders the posture KPIs, review list, opaque-key drill-down, and withheld-evidence gaps | [posture activity](../../../services/core-control-plane/src/fdai/core/assurance_twin/posture_activity.py), [runtime trigger](../../../services/core-control-plane/src/fdai/runtime/assurance_twin_posture.py), [delivery recorder](../../../services/core-control-plane/src/fdai/delivery/assurance_twin_posture.py), [durable ledger](../../../services/core-control-plane/src/fdai/delivery/persistence/state_store_assurance_twin_posture.py), [Operator projection](../../../services/operator-service/src/fdai_operator_service/assurance_twin_posture_projection.py), and [Console route](../../../console/src/routes/assurance-twin.tsx) | [posture activity tests](../../../services/core-control-plane/tests/assurance_twin/test_posture_activity.py), [runtime trigger tests](../../../services/core-control-plane/tests/runtime/test_assurance_twin_posture.py), [delivery tests](../../../services/core-control-plane/tests/delivery/test_assurance_twin_posture.py), [ledger tests](../../../services/core-control-plane/tests/persistence/test_state_store_assurance_twin_posture.py), [Operator projection tests](../../../services/operator-service/tests/test_assurance_twin_posture_projection.py), and [Console tests](../../../console/src/routes/assurance-twin.test.ts) |
