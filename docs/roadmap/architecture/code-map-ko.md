...
| 작업 흐름 복구 승인 및 보류 해제 | 정확한 복구 승인과 승인 사용, fence 세대, 무권한 증적을 포함한 승인 보호 원자적 해제 기본 연산입니다. 운영 보상 통합은 #630, 최종 실행 경로 fence는 #640에 남아 있습니다. | [복구 승인](../../../services/core-control-plane/src/fdai/core/workflow/recovery_admission.py), [자동화 보류](../../../services/core-control-plane/src/fdai/core/workflow/automation_hold.py), [작업 흐름 승인 상태](../../../services/core-control-plane/src/fdai/delivery/persistence/workflow_approval.py), [PostgreSQL 상태](../../../services/core-control-plane/src/fdai/delivery/persistence/postgres.py) | [복구 및 보류 테스트](../../../services/core-control-plane/tests/core/workflow/test_automation_hold.py) |
