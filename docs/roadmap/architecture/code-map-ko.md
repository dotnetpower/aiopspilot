...
translation_source_sha: 5764845c23c647c51a241da4dd7972e11b5c2087
...
| 대상 잠금 연속성과 디스패치 근거 | 검토된 대상 시스템 전략은 모호한 디스패치, 알 수 없는 커밋, 상실된 해제를 격리합니다. 영구 예약 뒤에 대상별 고유 generation fence를 시작하고 정확한 레코드 PostgreSQL CAS로 안전조건 묶음, 디스패치 시작, 전송 및 권위 있는 대상 시스템 관측, 새로운 해제 전 잠금 checkpoint를 저장합니다. 해결되지 않은 모든 상태는 대상 변경을 차단하며 권한이나 효과 검증 주장을 부여하지 않습니다. | [잠금 연속성](../../../services/core-control-plane/src/fdai/core/executor/lock_continuity.py), [fence 모델](../../../services/core-control-plane/src/fdai/core/executor/target_dispatch_fence.py), [디스패치 수명 주기](../../../services/core-control-plane/src/fdai/core/executor/safeguard_dispatch_checkpoint.py), [저장소 경계](../../../services/core-control-plane/src/fdai/core/executor/safeguard_dispatch_store.py), [PostgreSQL 저장소](../../../services/core-control-plane/src/fdai/delivery/persistence/postgres_safeguard_dispatch.py) | [잠금 테스트](../../../services/core-control-plane/tests/core/executor/test_lock_continuity.py), [fence 테스트](../../../services/core-control-plane/tests/core/executor/test_target_dispatch_fence.py), [checkpoint 테스트](../../../services/core-control-plane/tests/core/executor/test_safeguard_dispatch_checkpoint.py), [PostgreSQL 테스트](../../../services/core-control-plane/tests/persistence/test_postgres_safeguard_dispatch.py), [이행 테스트](../../../tests/integration/services/test_service_migration_inventory.py) |
