...
translation_source_sha: d7b633ef203f07c4204606359a1ca219d4df900b
...
| Core 안전조건 증명 최종 처리 | 디스패치 전 평가에서 고정한 전체 액션 다이제스트와 액션, 경로, 지문, 소스 개정, 잠금, 영구 멱등성 예약, 저장된 감사 의도에 결속된 타입 지정 증명 설명을 사용합니다. 순수 최종 처리기는 #620 무권한 묶음을 생성하지만 I/O를 수행하지 않습니다. | [디스패치 전 안전조건](../../../services/core-control-plane/src/fdai/core/executor/safeguards.py), [증명 최종 처리기](../../../services/core-control-plane/src/fdai/core/executor/safeguard_proofs.py) | [최종 처리기 테스트](../../../services/core-control-plane/tests/core/executor/test_safeguard_proofs.py) |
