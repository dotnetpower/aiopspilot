...
translation_source_sha: a6acb67c58a502d71b82b175ef18b2f745a10821
...
- **플랫폼-서비스 바인딩:** 루트 Terraform은 검토된 대상과 Key Vault 참조를 내보냅니다. 보호된
  ...
  같은 정확한 Operator 및 Core Container App Resource ID를 두 엔드포인트 서비스에 전달합니다.
  인벤토리 Job은 단일 기록기가 관계를 변환하기 전에 두 플랫폼 로그를 독립적으로 결합합니다. 비공개, 공유,
