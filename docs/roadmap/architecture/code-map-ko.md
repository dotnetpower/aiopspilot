...
translation_source_sha: 693129745c886324d7f8c4a729f6a422e353aaf1
...
| 의사 결정 근거 승인 파이프라인 | 정확한 증적 및 증명 5개 검증, StateStore 및 비공개 Blob 승인 공급자, 등록된 긍정적 경계의 프로덕션 조립, 보호된 정확한 배포 근거 축약, 게시 전 증명 및 런타임 principal이 읽기 전용인 90일 전용 불변 컨테이너 | [승인 공급자](../../../services/core-control-plane/src/fdai/delivery/persistence/state_store_decision_evidence.py), [Azure 읽기 담당](../../../services/core-control-plane/src/fdai/delivery/azure/decision_evidence.py), [보호된 워크플로](../../../.github/workflows/decision-evidence-admission.yml) 및 [전용 저장소](../../../infra/main.tf) | [영속성 테스트](../../../services/core-control-plane/tests/persistence/test_state_store_decision_evidence.py), [Azure 테스트](../../../services/core-control-plane/tests/delivery/azure/test_decision_evidence.py), [워크플로 테스트](../../../tests/integration/scripts/test_decision_evidence_admission_workflow.py) 및 [인프라 테스트](../../../tests/integration/infra/test_decision_evidence_admission_binding.py) |
