...
translation_source_sha: 5b890e03532c24538ad2bd096589ba1003c57469
...
| Core 계약과 프로바이더 경계 | Core 전용 타입, 프로바이더 프로토콜, 구성, 스트리밍, 텔레메트리, 범위가 제한된 알림 표시 및 기능 계약, 엄격한 operating-intent 다이제스트, 공유 승인 결속 change-window 구성, 공급자가 증명한 과거 획득 증적과 현재 fence 또는 세션 소유권 평가를 분리하는 무권한 리소스 잠금 근거 | [shared](../../../services/core-control-plane/src/fdai/shared/) 및 [resource_lock.py](../../../services/core-control-plane/src/fdai/shared/providers/resource_lock.py) | [shared 테스트](../../../services/core-control-plane/tests/shared/) 및 [리소스 잠금 계약 테스트](../../../services/core-control-plane/tests/providers/test_resource_lock_receipt.py) |
