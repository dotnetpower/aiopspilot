...
translation_source_sha: 5af5f94638e168df66ce559a3736e6466127a941
...
| Core 계약과 프로바이더 경계 | Core 전용 타입, 프로바이더 프로토콜, 구성, 스트리밍, 텔레메트리, 범위 제한 notification 표시/기능 계약, 엄격한 operating-intent digest 및 공유 승인 결속 change-window 구성 | [shared](../../../services/core-control-plane/src/fdai/shared/) | [shared 테스트](../../../services/core-control-plane/tests/shared/) |
