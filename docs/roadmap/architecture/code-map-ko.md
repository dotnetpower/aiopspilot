...
translation_source_sha: 8438ec22ce3570bfe586ad066a9f4d137d1a4f4b
...
| 런타임 라이선스 실행 상한 | PR 기반, 직접 API 및 도구 호출 권한 경계를 변경하지 않고 공유 Thor 라이선스 래퍼를 현재 시각 기준으로 선택적으로 구성하는 런타임 소유 경계 | [런타임 라이선싱](../../../services/core-control-plane/src/fdai/runtime/licensing.py)과 [공유 실행 게이트](../../../services/core-control-plane/src/fdai/core/executor/licensing_gate.py) | [런타임 라이선싱 테스트](../../../services/core-control-plane/tests/runtime/test_licensing.py)와 [실행 게이트 테스트](../../../services/core-control-plane/tests/core/executor/test_licensing_gate.py) |
