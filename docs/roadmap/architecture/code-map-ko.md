...
translation_source_sha: 2e1ce4590e9e11b53973aaf0a1f6e89e8e83b8a0
...
| 권위 있는 효과 전 감사 의도 | 콘텐츠 주소 기반 무권한 의도는 정확한 영구 예약 전환 증적을 포함하며 예약이 현재 상태일 때 생성해야 합니다. 추가 증적은 디스패치 전에 영속화, 권위 있는 정확한 읽기, 범위가 제한된 시간 순서를 요구합니다. 후보에 결속된 결과는 추가됨, 동일 중복, 충돌을 구분합니다. 공급자 경계는 정의했으며 영구 저장소 통합은 열린 작업입니다. | [감사 의도](../../../services/core-control-plane/src/fdai/core/executor/audit_intent.py) | [감사 의도 테스트](../../../services/core-control-plane/tests/core/executor/test_audit_intent.py) |
