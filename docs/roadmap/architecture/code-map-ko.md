...
translation_source_sha: d72b9e83de631695d840e1f122fa438fe4333d1d
...
| Core 계약과 프로바이더 경계 | Core 전용 타입, 프로바이더 프로토콜, 구성, 스트리밍, 텔레메트리, 소문자 16진수 operating-intent digest 경계 및 공유 승인 결속 change-window 프로바이더 구성 | [shared](../../../services/core-control-plane/src/fdai/shared/) | [shared 테스트](../../../services/core-control-plane/tests/shared/) |
