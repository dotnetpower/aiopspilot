...
translation_source_sha: 97beaaac08e112475c7691d12dc5d67df25b6eea
...
| Core 계약과 프로바이더 경계 | Core 전용 타입, 프로바이더 프로토콜, 구성, 스트리밍, 텔레메트리 및 소문자 16진수 operating-intent digest 경계 | [shared](../../../services/core-control-plane/src/fdai/shared/) | [shared 테스트](../../../services/core-control-plane/tests/shared/) |
