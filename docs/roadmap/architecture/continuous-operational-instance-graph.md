...
state-base completeness and object-ownership validation in `postgres_ontology_inventory.py`; this
module boundary does not create another graph writer or authority surface.
