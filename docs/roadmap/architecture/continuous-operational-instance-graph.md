...
The Operator lifecycle can also publish durable Incident intervention requests through its own
retry-safe outbox. That worker creates no runtime-call witness, graph edge, provider observation, or
execution authority.
