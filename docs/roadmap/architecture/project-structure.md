...
catalog load. A DR outcome binds the plan revision and recovery epoch to independent integrity and measured RPO/RTO evidence. DR objective evidence reports a nearest-rank p90, so a small cohort keeps its slowest measured run instead of reporting an
