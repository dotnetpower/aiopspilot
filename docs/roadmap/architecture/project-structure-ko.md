...
translation_source_sha: d91a330647329747f4fb00a7d999d554b529916a
...
| 추적 인제스트 | `TraceQueryProvider` | **CSP-중립성 계약** - [추적](csp-neutrality-ko.md#8-trace-query-계약---distributed-trace-spans) | `NoopTraceQueryProvider`; 설정 시 Azure 어댑터가 Application Insights를 연결합니다. Core는 일치하는 독립 인용 계측, 수집기 또는 헤더 전파 신호 하나가 있을 때만 추적 연속성 원인을 구분할 수 있습니다. | Tempo, Jaeger, Honeycomb 또는 다른 구간 어댑터 |
