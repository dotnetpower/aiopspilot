...
translation_source_sha: c4756d33555d4c0b515f9a4129dce2b9bcd53d66
...
사용 불가 결과를 유지합니다.
Operator 수명 주기는 자체 재시도 가능한 보낼 편지함을 통해 영속 Incident 개입 요청도 게시할
수 있습니다. 해당 작업자는 런타임 호출 증표, 그래프 edge, 프로바이더 관측 또는 실행 권한을
만들지 않습니다.
