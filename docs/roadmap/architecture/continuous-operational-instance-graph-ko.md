...
translation_source_sha: 260297428175a25e6aaa498ef6e60374618a9cf8
...
없을 수 있습니다. 이때 Virtual Network 내부 runner는 상태가 소유한 앱 이름, 리소스 그룹,
고정된 구독을 사용해 Azure에서 두 개의 정확한 Resource ID를 읽습니다. 이후 같은 폐쇄형 검증이
서로 다른 두 Container App ID를 요구한 뒤에만 서비스에 바인딩을 제공합니다. 프로바이더 읽기가
