...
translation_source_sha: 2bc2d6806dd71094636f7fc259a719cd36149bd5
...
경과 시간으로 사용하고 비어 있지 않은 실시간 오버레이를 조정 대기로 처리합니다. 따라서
오버레이 작업, 변경 수요 또는 최대 노후 상태가 실패 시간 부재로 계속 연기되지 않습니다.
