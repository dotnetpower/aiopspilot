...
translation_source_sha: 529ac68c0bf0b58752f6284cf2566d6c6862a704
...
- [ ] 승격 전에 정족수, 만료, 취소, 인수인계, 범위, 근거 및 침묵으로 권한을 부여하지 않는 테스트를 포함해 A3-E 사전 권한을 구현하고 shadow 평가합니다. 이 작업은 이슈 `#331`에서 추적합니다.
