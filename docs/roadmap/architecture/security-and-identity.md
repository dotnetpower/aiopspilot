...
- [x] Bind separately approved recovery through existing approval and decision-evidence contracts without mutating the hold under issue `#622`. Evidence: `recovery_admission.py`, `test_recovery_admission.py`, and 45 focused passing checks.
