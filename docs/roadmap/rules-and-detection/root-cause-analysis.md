...
|-------|----------------|
| `instrumentation` | The cited affected hop is missing from a dropped-context result or is present in an invalid-order result. |
...
but cannot select or authorize a recovery action.
