...
| 16a | [multi-channel-notification-delivery.md](interfaces/multi-channel-notification-delivery.md) | fan-out delivery to every enabled and configured A2/A4 channel, named channel bindings, per-channel durable delivery, partial-success outcomes, and the Teams Workflows webhook binding |
...
| 19r | [system-knowledge-service.md](interfaces/system-knowledge-service.md) | independent release-bound FDAI design and implementation knowledge service with a dedicated Teams mention bot and no operational authority |
| 19o | [ontology-query-coverage-implementation-plan.md](interfaces/ontology-query-coverage-implementation-plan.md) | audited implementation gaps and dependency-ordered work packages for manifests, query plans, semantic generations, topology history, causal evidence, and legacy cutover |
| 19p | [continuous-question-space.md](interfaces/continuous-question-space.md) | exact-release finite question cases, bilingual candidate generation, campaign evidence ledgers, strict v2 assurance, and bounded scheduling |
...
| 19j.1 | [recorded-resource-state.md](interfaces/recorded-resource-state.md) | shared recorded operational, provisioning, and availability facts, evidence qualifications, and generation-bound resource paging |
...
| 19q | [network-topology-visualization.md](interfaces/network-topology-visualization.md) | shared network vocabulary, authored reference diagrams, observed Console focus, path tracing, export, and visual integrity |
...
| # | Document | What it covers |
|---|----------|----------------|
| 25 | [implementation-plan.md](fork-and-sequencing/implementation-plan.md) | historical compatibility record for the rejected 2026-07-06 standard-set identifiers and the tested M1.2 starter-probe set; current authority stays with subsystem owners |
| 26 | [agent-pantheon-implementation.md](agents/agent-pantheon-implementation.md) | compact W0-W8 coordination summary, implementation ledger, and `PantheonRuntime` composition contract; roles and workflow rollout details stay with their focused owners |
