...
- **판사는 실행기가 아닙니다.** Forseti가 판단하고 Var가 권한이 있고 만료되지 않은 승인을
  전달합니다. Thor는 권한 상한, Saga receipt, 안정적 멱등성 예약, 소유자가 fencing된 분산
  리소스 claim을 다시 확인한 뒤 실행하며 재시작 모호성은 `execution_unknown`으로 유지합니다.
