...
When bounded transcript storage exceeds its byte ceiling, serialization finds the longest retained
suffix with logarithmic full-array encodes instead of repeatedly removing and encoding one turn.
