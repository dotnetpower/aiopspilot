...
copy for a genuinely empty ledger and for rows withheld by an evidence gap. At narrow widths, opaque provenance and withheld identity values wrap inside the primary content, table overflow stays inside its scroll
