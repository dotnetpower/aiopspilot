...
applicability, and satisfaction. The WAF checklist shows all 59 pinned definitions with immutable
workload evidence, while the CAF sibling view shows all 15 methodology and landing-zone areas with
owner, cadence, approved exception, and evidence limitations. Neither view calculates compliance
in the browser or writes evidence.
