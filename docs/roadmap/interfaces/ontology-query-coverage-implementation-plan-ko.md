...
translation_source_sha: 3a71522335873c8e6851c43cf5e5003bc3d9ef21
...
| 정확한 의미 프롬프트 프로필 및 복구 예산 | implemented | `core/prompts/profiles.py`, `semantic_query_azure_composition.py`, Azure 의미 계획 어댑터, 집중 프롬프트 및 의미 어댑터 검사 | Frame과 plan 조립은 정확한 활성 아티팩트를 고정하고 재실행 근거와 전체 요청 예산을 전달합니다. 일반 T2 frame 복구는 33,000자 legacy frame에 내용을 덧붙이지 않고 별도의 compact 역할을 사용합니다. Compact 판단, frame 및 plan 처리군은 shadow로 유지합니다. |
