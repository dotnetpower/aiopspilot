...
translation_source_sha: de402793c8c83fa80d00ea8376e9fce5c2a855ff
...
| 신규 구독 로컬 조정기 | implemented | `genesis-up.sh`, 비공개 조정기, 승인, 이미지, 기반 계층 적용, Bastion, 등록, 상태 인계 모듈 및 집중 수명 주기 테스트 | 15단계 경로는 점유를 검증 전용으로 재개하고 보호된 애플리케이션 계획 전에 중단합니다. 통제된 Azure 증적은 남아 있습니다. |
