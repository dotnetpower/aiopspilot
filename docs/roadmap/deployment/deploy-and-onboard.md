...
their private endpoints, a root-managed A record in the runner's existing Blob DNS zone, read-only binding, and independently declared root Job. Exact apply is
