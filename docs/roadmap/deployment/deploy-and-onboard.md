...
When either change accelerator is disabled, the Job does not read its optional collection-policy
entry and contributes no cursor prefix or stale-cursor deadline for that source.
