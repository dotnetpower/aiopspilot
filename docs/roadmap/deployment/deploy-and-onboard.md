...
their private endpoints, a dedicated root-managed runner link to the shared Blob DNS zone, read-only binding, and independently declared root Job. Exact apply is
