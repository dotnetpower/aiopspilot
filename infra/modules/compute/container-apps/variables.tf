...
variable "rca_reader_identity_client_id" {
  description = "Client id of the dedicated Activity Log RCA reader identity."
  type        = string
  default     = ""
}
...
variable "wara_assessment_workload_ids" {
  description = "Deployment-owned ontology Workload ids assessed by the WARA job."
  type        = list(string)
  default     = []
