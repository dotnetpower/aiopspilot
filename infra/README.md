...
After an authorized apply, the deployment workflow reads the Job back and verifies that its
inventory container uses the exact digest-pinned Core image selected by the protected plan.
